...
const resolveAuthClientBaseUrl = () => {
    try {
        ...
        console.warn('Unable to determine BetterAuthClient base URL, using relative paths.', error);
    }
    return '';
};
...
class BetterAuthClient {
    constructor() {
        this.baseURL = resolveAuthClientBaseUrl();
    ...
    async getSession() {
        try {
            const response = await fetch(this.buildUrl('/api/auth/get-session'), {
                credentials: 'include'
            });
    ...
    async signUp(email, password, fullName) {
        try {
            const response = await fetch(this.buildUrl('/api/auth/sign-up'), {
                method: 'POST',
                headers: {
    ...
    async signIn(email, password) {
        try {
            const response = await fetch(this.buildUrl('/api/auth/sign-in'), {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async verifyEmail(email, code) {
        try {
            const response = await fetch(this.buildUrl('/api/auth/verify-email'), {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async resendVerificationCode(email) {
        try {
            const response = await fetch(this.buildUrl('/api/auth/send-verification-email'), {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async signOut() {
        try {
            const response = await fetch(this.buildUrl('/api/auth/sign-out'), {
                method: 'POST',
                credentials: 'include'
            });
